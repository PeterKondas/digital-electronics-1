...
HD_PWD='C:/Users/pepoo/Documents/PetoGit/digital-electronics-1/labs/05-ffs/flip_flops/flip_flops.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log t_ff_rst.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source t_ff_rst.tcl -notrace
